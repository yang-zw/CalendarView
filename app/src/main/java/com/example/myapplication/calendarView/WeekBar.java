...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.example.myapplication.calendarView.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.example.myapplication.calendarView.WeekBar".equalsIgnoreCase(getClass().getName())) {
